...
process process_matrix {
    ...
    output:
        ...
        tuple val(meta), val(feature), path("${feature}_processed_feature_bc_matrix"), emit: processed, optional: true
        tuple val(meta), val(feature), path("${feature}.expression.mean-per-cell.tsv"), emit: meancell, optional: true
        ...
        tuple val(meta), val(feature), path("${feature}.expression.umap*.tsv"), emit: umap, optional: true
    script:
